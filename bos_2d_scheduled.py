# -*- coding: utf-8 -*-
"""
Created on Fri Oct  1 13:35:55 2021
...
def train_model(batch1, batch2, ratio1, ratio2):
    ...
    model.fit(optX_train, opty_train, batch_size=round(batch2), validation_data=(optX_test, opty_test), epochs=50, callbacks=[earlystop2, checkpoint])
